...
<div class=" p-3 mb-5 bg-white rounded border">
    ...
    <!-- Add material button -->
    <button type="button" class="btn btn-primary float-right ml-3" data-toggle="modal"data-target="#inclusionModal">Add Exclusion
    </button>
