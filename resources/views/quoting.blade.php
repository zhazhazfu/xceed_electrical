            ...
            <div class="form-row">
                ...
                <div class="col-sm-6 pb-2">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" id="today" readonly>
                    </div>
                </div>
            </div>
...
<script>// on change function to get subcate, item and des when select
...
@push('js')
<script type="text/javascript"> //remove and add jobs
