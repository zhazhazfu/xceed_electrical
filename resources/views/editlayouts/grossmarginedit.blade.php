...
<script>
    function showSelected(element){
        document.getElementById('gm_rate').value = element.value;
    } 
</script>
...
<div class="p-3 rounded border">
    <div class="row">
        <div class="col-sm">
            ...
            <form method="post" action="{{action('GrossMarginController@update', $pk_gm_id)}}">{{csrf_field()}}
                ...
                <div class="form-group">
                    <select class='form-control'  id="gm_percentage" name="gm_percentage" onchange="showSelected(this)">
                        ...
                        <option value="1.739" selected>42.5</option>
                ...
                <div class="form-group">
                    <label for="inputGrossMargin">
                        <h5>GM Rate</h5>
                    </label>
                    <input type="input" class="form-control" id="gm_rate" name="gm_rate" readonly>
                </div>
