...
class PerpointController extends Controller
{
    public function index()
    {
        ...
        return view('perpointquote', compact('pageHeading', 'perpointquote', 'businessDetails', 'customers', 'categories', 'subCategories', 'items', 'quoteterms', 'discounts', 'grossmargins', 'exclusions', 'inclusions', 'companyCosts', 'employeeCosts', 'prefixes'));
    }
...
public function show($id="")
{
    ...
    return view('perpointquote', compact('pageHeading', 'subCategories', 'categoryName'));
}
